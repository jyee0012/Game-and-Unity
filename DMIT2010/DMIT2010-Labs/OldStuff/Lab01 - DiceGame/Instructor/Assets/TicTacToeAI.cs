            ...
            switch (numberOfTurns)
            {
                ...
                case 3:
                    if (squares[4] == (int)gameState.Player2Turn) // Player 2 has the center
                    {
                        ...
                        else if (squares[7] == (int)gameState.Player1Turn && squares[3] == (int)gameState.Player1Turn)
                        {
                            SelectSquare(6);
                            selected = true;
                        }
                        else if (squares[7] == (int)gameState.Player1Turn && squares[5] == (int)gameState.Player1Turn)
                        {
                            SelectSquare(8);
                            selected = true;
                        }
